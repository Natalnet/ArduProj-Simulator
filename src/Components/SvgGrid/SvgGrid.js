...
export default function SvgGrid({ pagination, PAGINATION_SETTINGS }) {
    ...
    return (
        <div className="Grid">
            {data.map((d, index) => {
                ...
                if (
                    index < pagination * PAGINATION_SETTINGS ||
                    index >= pagination * PAGINATION_SETTINGS + PAGINATION_SETTINGS
                )
                    return null;
                if (!d.breadboard) return null;
